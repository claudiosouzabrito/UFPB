...
void loop() {
    ...
    bufferPayload[1] = 0x02;
    bufferPayload[2] = 0x03;
    bufferPayload[3] = univ++;
    
    if (PrepareFrameCommand(0x00, 0x10, &bufferPayload[0], 4) != MESH_OK) {
        Serial.println("Erro de mensagem enviada");
    }
    else {
      Serial.print("mensagem enviada: ");
      Serial.print(bufferPayload[3], HEX);
      Serial.println("");
    }
    delay(1000);
    /* Sends packet */
    SendPacket();
  //  memset(&bufferPayload[0], 0, MAX_BUFFER_SIZE);
}

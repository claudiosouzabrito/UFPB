READ.ME DO PROJETO DE LP2:

RESTRICOES:
-O CODIGO FONTE PRECISA ESTAR DENTRO DA PASTA REQS

-QUANDO O PROGRAMA FAZ A ANALISE DO ARQUIVO JPG ELE DA SEGMENTATION FAULT, NAO CONSEGUI UMA IMAGEM MENOR QUE AQUELA,
 O LIMITE DE BYTE EH MUITO PEQUENO

-O OBJETIVO DO PROJETO ERA FAZER UM SERVIDOR QUE SE COMUNICASSE COM O CLIENTE, POREM EU FIZ AO CONTRARIO, POIS NAO CONSEGUI DA OUTRA FORMA

-PARA COMPILAR O CODIGO: g++ prova2.cpp -o prova -pthread -std=c++11

----------------------------------------------------------------------------------------------------------------

BOAS NOTICIAS:
-SOCKETS BEM IMPLEMENTADOS

-SEMAFOROS BEM IMPLEMENTADOS

-TRATAMENTO DE ERROS DE GET BEM IMPLEMENTADOS
